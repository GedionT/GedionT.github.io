  ...
  ({ children, className = "", delay = 0 }, ref) => {
    ...
    return (
      <motion.div
        ...
        className={`bg-white/70 backdrop-blur-3xl border border-slate-200 p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 relative overflow-hidden group/card ${className}`}
      >
